...
void remove_point_by_heght(pcl::PointCloud<pcl::PointSurfel>::Ptr cloud, nav_msgs::OccupancyGrid *map){
		...
		for(size_t i = 0; i < cloud->points.size(); i++){
			if((cloud->points[i].x < -12.015 || -8.504 < cloud->points[i].x) || (cloud->points[i].y < 24.772 || 32.367 < cloud->points[i].y)){
					...
					if((cloud->points[i].x < -58.496 || -56.979 < cloud->points[i].x) || (cloud->points[i].y < 22.509 || 26.457 < cloud->points[i].y)){
						if((cloud->points[i].x < -59.799 || -57.932 < cloud->points[i].x) || (cloud->points[i].y < 23.230 || 24.943 < cloud->points[i].y)){
							if((cloud->points[i].x < -20.777 || -20.306 < cloud->points[i].x) || (cloud->points[i].y < 27.792 || 28.463 < cloud->points[i].y)){
								if((cloud->points[i].x < -0.164 || 4.065 < cloud->points[i].x) || (cloud->points[i].y < 189.186 || 196.285 < cloud->points[i].y)){
									if((cloud->points[i].x < -6.376 || 0.501 < cloud->points[i].x) || (cloud->points[i].y < 24.821 || 51.081 < cloud->points[i].y)){
										if((cloud->points[i].x < 18.141 || 23.042 < cloud->points[i].x) || (cloud->points[i].y < 248.330 || 264.721 < cloud->points[i].y)){
											if((cloud->points[i].x < 22.028 || 27.926 < cloud->points[i].x) || (cloud->points[i].y < 203.976 || 208.464 < cloud->points[i].y)){
												if((cloud->points[i].x < 20.784 || 57.983 < cloud->points[i].x) || (cloud->points[i].y < 53.408 || 56.367 < cloud->points[i].y)){
													if((cloud->points[i].x < 64.704 || 69.085 < cloud->points[i].x) || (cloud->points[i].y < 235.324 || 248.236 < cloud->points[i].y)){
														if((cloud->points[i].x < -2.274 || 2.218 < cloud->points[i].x) || (cloud->points[i].y < -0.494 || 19.626 < cloud->points[i].y)){
															if((cloud->points[i].x < -34.943 || -31.223 < cloud->points[i].x) || (cloud->points[i].y < 47.739 || 52.289 < cloud->points[i].y)){
																if((cloud->points[i].x < -12.490 || -6.654 < cloud->points[i].x) || (cloud->points[i].y < 50.633 || 55.113 < cloud->points[i].y)){
																	if((cloud->points[i].x < -13.495 || -1.361 < cloud->points[i].x) || (cloud->points[i].y < -4.292 || 4.927 < cloud->points[i].y)){
																		int x = int((cloud->points[i].x - map->info.origin.position.x) / R);
																		// cout<<"x : "<<x<<endl;
																		int y = int((cloud->points[i].y - map->info.origin.position.y) / R);
																		// cout<<"y : "<<y<<endl;

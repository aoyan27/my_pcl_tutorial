...
{
        ros::init(argc,argv,"infant_curvature_220");
        ros::NodeHandle n;
        ...
        ros::Subscriber sub = n.subscribe("eth_220/point_cloud_3",10,callback);
        pub_cur = n.advertise<sensor_msgs::PointCloud2>("point_cloud2/curvature_obstacle_220",10);
        pub_real = n.advertise<sensor_msgs::PointCloud2>("point_cloud2/curvature_real_220",10);
        ros::Rate rate(40);
        while(ros::ok())
        {
                ros::spinOnce();

...
void create_obstacle_map(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, nav_msgs::OccupancyGrid *map){
	...
	// pcl::io::savePCDFile("obs_cloud_data_din_filtered.pcd", *filtered_cloud);
	pcl::io::savePCDFile("obs_cloud_data_d_kan_velo90test_filtered.pcd", *filtered_cloud);
...
int main (int argc, char** argv){
	...
	// string filename = "/home/amsl/ikuta_robosym2016/diff_filtered.pcd";

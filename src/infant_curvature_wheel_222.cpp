...
//                        double oval = ( (pcl_curvature.points[i].x) * (pcl_curvature.points[i].x))/(0.5*0.5) + (pcl_curvature.points[i].y * pcl_curvature.points[i].y)/(0.60 * 0.60);
double oval = ( (pcl_curvature.points[i].x) * (pcl_curvature.points[i].x))/(0.5*0.5) + ((pcl_curvature.points[i].y+0.2) * (pcl_curvature.points[i].y+0.2))/(0.50 * 0.50);
                        ...
                        if( ( -1.10 < pcl_curvature.points[i].z) && (pcl_curvature.points[i].z <0.20) && (oval > 1) && (pcl_curvature.points[i].curvature > 0.07))
                        {
...
{
        ros::init(argc,argv,"infant_curvature_wheel_222");
        ros::NodeHandle n;
        ...
        pub_obstacle = n.advertise<sensor_msgs::PointCloud2>("point_cloud2/curvature_obstacle_222",10);
        pub_empty = n.advertise<sensor_msgs::PointCloud2>("point_cloud2/curvature_empty_222",10);
